...
UUID=${UUID:-'f76f20e6-8c10-46cc-ba01-29fcec5f40da'}
VMESS_WSPATH=${VMESS_WSPATH:-'/4YrMd1yf'}
VLESS_WSPATH=${VLESS_WSPATH:-'/ng46fp7x'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/PAascz'}
SS_WSPATH=${SS_WSPATH:-'/UwYsVizqch8u'}
